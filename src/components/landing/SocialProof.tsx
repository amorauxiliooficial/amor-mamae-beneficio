...
export const SocialProof: React.FC = () => {
  return (
    <section className="relative w-full overflow-hidden bg-black">
      ...
      <div className="relative w-full min-h-[100svh] md:min-h-[80vh] flex flex-col">
        
        {/* Imagem de fundo */}
        <img
          src={teamPhoto}
          alt="Equipe Amor Auxílio Maternidade"
          className="absolute inset-0 w-full h-full object-cover object-[center_15%] md:object-[center_55%] brightness-105 contrast-[1.03]"
        />
