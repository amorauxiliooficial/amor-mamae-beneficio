    ...
    <section className="relative bg-gradient-to-br from-white to-brand-pink/10 overflow-hidden">
      <div className="container mx-auto px-4 py-6 md:py-12">
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-6 md:gap-12">
          {/* Imagem primeiro no mobile para melhor hierarquia visual */}
          <div className="w-full md:w-7/12 relative flex justify-center order-1 md:order-2">
          ...
          {/* Texto depois da imagem no mobile */}
          <div className="w-full md:w-5/12 space-y-4 md:space-y-6 z-10 text-center md:text-left order-2 md:order-1 mt-6 md:mt-0">
